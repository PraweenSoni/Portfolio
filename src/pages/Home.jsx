    ...
    <>
      <section className="HomeSec">
        <p>
          ...
          <br /> <br />
          So, <span>Welcome to my portfolio</span>, where I showcase my <span>skills</span>, <span>projects</span>, and growth in web development and IoT!
          <br /> <br />
          Explore my portfolio, <br />
          <span>Thank You 🙂!</span>
        </p>
      </section>
    </>
